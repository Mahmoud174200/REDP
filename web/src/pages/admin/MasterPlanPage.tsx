              ...
              <>
                ...
                <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap' }}>
                  ...
                  >
                    ...
                    {Object.entries(buildingTypeLabels).map(([val, label]) => (
                ...
                {filteredBuildings.length === 0 ? (
                  <div style={{ textAlign: 'center', padding: '30px 20px', color: 'var(--text-muted)' }}>
                    <p>No buildings match your search filters.</p>
                  </div>
                ) : (
                            ...
                            <div key={f.id} style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
                              <div style={{ ...styles.floorRow, cursor: 'pointer' }} onClick={() => toggleFloor(f.id)}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }} onClick={e => e.stopPropagation()}>
                                  ...
                                  <button style={{ ...styles.btnSecondary, padding: '3px 8px', fontSize: '0.68rem', color: '#059669', borderColor: 'rgba(5, 150, 105, 0.2)' }} onClick={() => openAddUnitModal(b, f)}>
                                    <Plus size={10} /> Add Unit
                                  </button>
                                  {f.floor_type !== 'basement' && f.floor_type !== 'roof' && (
                                    <button style={{ ...styles.btnSecondary, padding: '3px 8px', fontSize: '0.68rem' }} onClick={() => openGenUnitsModal(b, f)}>
                                      <LayoutGrid size={10} /> Gen Units
                                    </button>
                                  )}
                                  <button style={{ ...styles.btnSecondary, padding: '3px 6px' }} onClick={() => openEditFloorModal(b, f)}>
                                    <Edit2 size={10} />
                                  </button>
                                  <button style={{ ...styles.btnDanger, padding: '3px 6px' }} onClick={() => handleDeleteFloor(b.id, f.id)}>
                                    <Trash2 size={10} />
                                  </button>
                                </div>
                              </div>
                ...
                {/* Pagination Controls */}
                {totalPages > 1 && (
                  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px', marginTop: '24px', borderTop: '1px solid rgba(0,0,0,0.05)', paddingTop: '16px' }}>
                    <button
                      type="button"
